...
if (isset($_POST['btn-save'])) {
    ...
    if ($check_stmt->rowCount() > 0) {
        ...
        $sql = "UPDATE members SET fullname = :fullname, phone = :phone, password = :password WHERE id = :id";
        $stmt = $conn->prepare($sql);
                            ...
                            <div class="row">
                                <div class="col-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" disabled value="<?= $result['username'] ?>" required name="username" class="form-control form-control-border border-width-2" placeholder="Username">
                                    </div>
                                </div>
                                <div class="col-6">
                                    <div class="form-group">
